              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || form.site_name || "hermes-proxy") +
                        " 100 " +
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/ca0fgh/hermes-proxy/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/ca0fgh/hermes-proxy/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/ca0fgh/hermes-proxy/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/ca0fgh/hermes-proxy/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
