  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. hermes-proxy-backups), choose a region',
    ...
    accounts: {
      ...
      types: {
        ...
        soraApiKeyHint: 'Connect to another hermes-proxy or compatible API',
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by hermes-proxy, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within hermes-proxy.',
      ...
      pinned: 'Pinned',
      pinToTopSuccess: 'Account pinned to top successfully',
      unpinFromTopSuccess: 'Account unpinned successfully',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another hermes-proxy instance.',
      ...
      soraUpstreamBaseUrlHint: 'Upstream Sora service URL (another hermes-proxy instance or compatible API)',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for hermes-proxy end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for hermes-proxy end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'hermes-proxy',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'hermes-proxy',
        useTls: 'Use TLS',
