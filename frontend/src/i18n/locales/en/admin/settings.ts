export default {
    settings: {
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on hermes-proxy orders; the upstream type is sent as EasyPay type.',
