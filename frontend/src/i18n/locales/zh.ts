export default {
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 hermes-proxy-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    accounts: {
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 hermes-proxy 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 hermes-proxy 端解除该限制。',
      ...
      unpinFromTop: '取消置顶',
      pinned: '置顶',
      pinToTopSuccess: '账号已置顶',
      unpinFromTopSuccess: '账号已取消置顶',
      pinToggleFailed: '更新置顶状态失败',
      refreshToken: '刷新令牌',
      noAccountsYet: '暂无账号',
      ...
      types: {
        ...
        soraApiKeyHint: '连接另一个 hermes-proxy 或兼容 API',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 hermes-proxy 实例的场景。',
      ...
      testModel: '测试模型',
      testPrompt: '提示词："hi"',
      soraUpstreamBaseUrlHint: '上游 Sora 服务地址（另一个 hermes-proxy 实例或兼容 API）',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 hermes-proxy 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 hermes-proxy 用户登录',
