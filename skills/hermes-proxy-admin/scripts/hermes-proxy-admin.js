...
function usage() {
  console.log(`Usage:
  hermes-proxy-admin.js accounts list [--page-size 200] [--page N] [--search TEXT] [--platform openai] [--type oauth] [--status active] [--group NAME] [--privacy-mode MODE] [--sort-by name] [--sort-order asc]
  hermes-proxy-admin.js accounts export [--ids 1,2] [--file accounts.json] [--include-proxies false] [list filters...]
  hermes-proxy-admin.js accounts import-data --file accounts.json [--skip-default-group-bind]
  hermes-proxy-admin.js accounts create --json '{...}' | --file account.json
  hermes-proxy-admin.js accounts update <id> --json '{...}' | --file patch.json
  hermes-proxy-admin.js accounts get <id>
  hermes-proxy-admin.js accounts delete <id>
  hermes-proxy-admin.js accounts keep-only --name <account-name>
  hermes-proxy-admin.js accounts usage <id> [--source SOURCE] [--force]
  hermes-proxy-admin.js accounts stats <id> [--days 30]
  hermes-proxy-admin.js accounts today-stats <id>
  hermes-proxy-admin.js accounts batch-today-stats --ids 1,2
  hermes-proxy-admin.js accounts set-status <id> <active|paused|...>
  hermes-proxy-admin.js accounts set-schedulable <id> <true|false>
  hermes-proxy-admin.js accounts clear-error <id>
  hermes-proxy-admin.js accounts clear-rate-limit <id>
  hermes-proxy-admin.js accounts recover-state <id>
  hermes-proxy-admin.js accounts reset-quota <id>
  hermes-proxy-admin.js accounts refresh <id>
  hermes-proxy-admin.js accounts test <id>
  hermes-proxy-admin.js accounts models <id>
  hermes-proxy-admin.js accounts sync-models <id>
  hermes-proxy-admin.js accounts apply-oauth <id> --json '{...}' | --file credentials.json
  hermes-proxy-admin.js accounts batch-create --file accounts.json
  hermes-proxy-admin.js accounts batch-update-credentials --json '{...}' | --file payload.json
  hermes-proxy-admin.js accounts bulk-update --ids 1,2 --json '{...}' | --file patch.json
  hermes-proxy-admin.js accounts batch-refresh --ids 1,2
  hermes-proxy-admin.js accounts batch-clear-error --ids 1,2
  hermes-proxy-admin.js accounts temp-unschedulable <id>
  hermes-proxy-admin.js accounts reset-temp-unschedulable <id>
  hermes-proxy-admin.js accounts crs-preview --json '{...}' | --file payload.json
  hermes-proxy-admin.js accounts crs-sync --json '{...}' | --file payload.json
  hermes-proxy-admin.js accounts import-codex-session --json '{...}' | --file payload.json
  hermes-proxy-admin.js accounts antigravity-default-model-mapping
  hermes-proxy-admin.js accounts import-json --file <path> --template-name <name> [--skip-name <name>] [--dry-run]
  hermes-proxy-admin.js groups all
  hermes-proxy-admin.js proxies all
  hermes-proxy-admin.js redeem-codes list [--page-size 200] [--page N] [--type balance] [--status unused] [--search TEXT] [--sort-by id] [--sort-order desc]
  hermes-proxy-admin.js redeem-codes export [--file redeem-codes.csv] [list filters...]
  hermes-proxy-admin.js redeem-codes get <id>
  hermes-proxy-admin.js redeem-codes generate --json '{...}' | --file payload.json [--idempotency-key KEY]
  hermes-proxy-admin.js redeem-codes create-and-redeem --json '{...}' | --file payload.json [--idempotency-key KEY]
  hermes-proxy-admin.js redeem-codes batch-update --ids 1,2 --json '{...}' | --file fields.json
  hermes-proxy-admin.js redeem-codes delete <id>
  hermes-proxy-admin.js redeem-codes batch-delete --ids 1,2
  hermes-proxy-admin.js redeem-codes expire <id>
  hermes-proxy-admin.js redeem-codes stats
  hermes-proxy-admin.js error-rules list|get|create|update|delete|toggle ...
  hermes-proxy-admin.js tls-profiles list|get|create|update|delete ...
  hermes-proxy-admin.js api <GET|POST|PUT|DELETE> <admin-path> [--json '{...}' | --file payload.json]
`);
}
