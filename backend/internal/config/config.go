...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/hermes-proxy")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "hermes-proxy")
	...
	viper.SetDefault("database.dbname", "hermes-proxy")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "hermes-proxy:")
...
func GetServerAddress() string {
	...
	v.AddConfigPath("/etc/hermes-proxy")
