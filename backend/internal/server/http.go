...
import (
	...
	"github.com/ca0fgh/hermes-proxy/internal/pkg/websearch"
...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditService, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient)
}
