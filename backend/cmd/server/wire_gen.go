...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	auditService := service.NewAuditService(auditRepository, configConfig)
	opsHandler := admin.NewOpsHandler(opsService, auditService)
	...
	soraSDKClient := service.NewSoraSDKClient(configConfig, httpUpstream, openAITokenProvider)
	...
	soraMediaStorage := service.NewSoraMediaStorage(configConfig)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditService, apiKeyService, subscriptionService, opsService, settingService, redisClient)
